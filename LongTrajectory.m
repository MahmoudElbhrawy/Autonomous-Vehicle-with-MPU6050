...
tspan_straight_2 = [0 2];  % Time to move straight (2 seconds per side)
...
hold on
grid on
title('XY Trajectory of Vehicle in a Rectangle Path')
...
carBody = plot(0, 0, 'bo', 'MarkerSize', 10, 'MarkerFaceColor', 'r');
trajectoryLine = animatedline('LineWidth', 2, 'Color', 'b');
